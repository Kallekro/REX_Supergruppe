...
class Camera(object):
    ...
    def __init__(self, camidx, robottype='arlo'):
        """Constructor:
        ...
        if piCameraFound:
            ...
            self.cam = picamera.PiCamera(camera_num=camidx, resolution=self.imageSize, framerate=5)
...
if (__name__=='__main__'):
    ...
    WIN_RF3 = "Undistorted robot view - gray";
    #cv2.namedWindow(WIN_RF3);
    #cv2.moveWindow(WIN_RF3, 50       , 50);
