...
sigma_distance=5.0 # chose a number
sigma_theta=0.5

# Landmarks.
# The robot knows the position of 2 landmarks. Their coordinates are in cm.
#landmarks = [(0.0, 0.0), (300.0, 0.0)]
#sigma, sigma_theta = 0.5
...
while True:
    ...
    #This shall not be used other than testing, it should be drivining or
    #Turning in respect to it's belife
    ...
    #Plan - Drive according to the distance and angle from the nearest landmark
    #If you are in a distnce of 10 cm (use sensor) of a landmark, turn till
    #you find next one, and drive half the distance towards it!
    #Write some logic, that determins if we want to move straight, or turn some more


    #We'll use the control data to move the particles along with us,
    #Use move_particle, to make the particles move along.
    #Move them for every action. To make it simple for ourself
    #We only either move forward or turn, but never in the same time
    #That way we can make a simple particle move, and belife update
